...
const Experience:React.FC = () => {
  return (
    <div id='experience' className='flex text-center bg-lightgrey w-full flex-col pb-16'>
        <h2 className='text-newblack text-3xl font-bold mt-8 mb-2 lg:text-4xl'>Trust Our Experience</h2>
